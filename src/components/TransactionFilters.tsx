...
interface TransactionFiltersProps {
  ...
  filterDependency: string; // Mantido para compatibilidade de interface, mas ignorado
  onDependencyChange: (value: string) => void; // Mantido para compatibilidade de interface, mas ignorado
